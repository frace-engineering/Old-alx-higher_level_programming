...
class Base:
    ...
    def create(cls, **dictionary):
        """ Return a class instance from a disctionary of attributes.
        Args:
            **dictionary (dict): key/value pairs of ttributes to initialize.
        """
    ...
    def load_from_file(cls):
        """Return a list of classes instantiated from a file o JSON string.
    ...
    def draw(list_rectangles, list_squares):
        ...
        Args:
            list_rectangles (list): Alist of Rectangle objects to draw.
